...
class LocaliseController extends JControllerLegacy
{
	...
	public function display($cachable = false, $urlparams = false)
	{
		...
		// Check for edit form.
		elseif ($vName == 'language' && $layout == 'edit' && !$this->checkEditId('com_localise.edit.language', $id))
		{
		...
		elseif ($vName == 'package' && $layout == 'edit' && !$this->checkEditId('com_localise.edit.package', $id))
		{
			// Somehow the person just went to the form - we don't allow that.
			$this->setError(JText::sprintf('JLIB_APPLICATION_ERROR_UNHELD_ID', $id));
			$this->setMessage($this->getError(), 'error');
		...
		elseif ($vName == 'packagefile' && $layout == 'edit' && !$this->checkEditId('com_localise.edit.packagefile', $id))
		{
			// Somehow the person just went to the form - we don't allow that.
			$this->setError(JText::sprintf('JLIB_APPLICATION_ERROR_UNHELD_ID', $id));
			$this->setMessage($this->getError(), 'error');
		...
		elseif ($vName == 'translation' && $layout == 'edit' && !$this->checkEditId('com_localise.edit.translation', $id))
		{
			// Somehow the person just went to the form - we don't allow that.
			$this->setError(JText::sprintf('JLIB_APPLICATION_ERROR_UNHELD_ID', $id));
			$this->setMessage($this->getError(), 'error');
